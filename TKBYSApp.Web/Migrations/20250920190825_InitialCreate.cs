        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TalepEdenPersonelId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MalzemeAdi = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Gerekce = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    BelgeYolu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SatinAlmaTalepleri", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SatinAlmaTalepleri_AspNetUsers_TalepEdenPersonelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TKBYSNo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Ad = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Ozellikler = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Malzemeler_Depolar_DepoId",
                        column: x => x.DepoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnaylayanYetkiliId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Durum = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Zimmetler_AspNetUsers_OnaylayanYetkiliId",
                        column: x => x.OnaylayanYetkiliId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Malzemeler_DepoId",
                table: "Malzemeler",
                column: "DepoId");

            migrationBuilder.CreateIndex(
                name: "IX_Malzemeler_TKBYSNo",
                table: "Malzemeler",
                column: "TKBYSNo",
                unique: true,
                filter: "[TKBYSNo] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_SatinAlmaTalepleri_TalepEdenPersonelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Zimmetler_OnaylayanYetkiliId",
                table: "Zimmetler",
                column: "OnaylayanYetkiliId");
